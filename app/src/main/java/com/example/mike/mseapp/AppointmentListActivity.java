...
public class AppointmentListActivity extends AppCompatActivity {
    ...
    private void setupRecyclerView(@NonNull RecyclerView recyclerView) {
        recyclerView.setAdapter(new SimpleItemRecyclerViewAdapter(ApptMgr.getInstance().apptList));
    }
    ...
    public class SimpleItemRecyclerViewAdapter
        ...
        private final List<Appointments> mValues;

        public SimpleItemRecyclerViewAdapter(List<Appointments> items) {
            mValues = items;
        }
            ...
            holder.mView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    if (mTwoPane) {
                        ...
                        arguments.putString(AppointmentDetailFragment.ARG_ITEM_ID, holder.mItem.getId()+"");
                        ...
                        intent.putExtra(AppointmentDetailFragment.ARG_ITEM_ID, holder.mItem.getId()+"");
